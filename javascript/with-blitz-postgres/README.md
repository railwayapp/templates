...
```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/with-blitz-postgres
```

Ensure the `.env.test.local` file has required environment variables:

```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/with-blitz-postgres_test
```
